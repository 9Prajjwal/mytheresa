function navbar() {
    ...
    <div id="second_part">
        <a><p>Signup for Newsletter</p></a>
        <a><p id="ma">My account</p></a>
        <a><p id="wl">My Wishlist</p></a>
        <a><p>International | English</p></a>
    </div>
</div>
<div id="mid">
    <div id="stdiv">
        <img src="https://www.mytheresa.com/skin/frontend/mytheresa/default/images/logo.png?v=20220608T143740" alt="">
    </div>
    <div id="nddiv">
        <p>SHOPPING BAG</p>
        <h5 id="count"></h5>
